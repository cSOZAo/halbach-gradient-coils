...
# Ensure pipeline directory is on sys.path when invoked from project root.
_PIPELINE_DIR = os.path.dirname(os.path.abspath(__file__))
if _PIPELINE_DIR not in sys.path:
    sys.path.insert(0, _PIPELINE_DIR)
if cfg.PYCOILGEN_ROOT not in sys.path:
    sys.path.insert(0, cfg.PYCOILGEN_ROOT)
...
TARGET_RY = cfg.TARGET_RY
TARGET_RZ = cfg.TARGET_RZ
RESOL_RADIAL = cfg.RESOL_RADIAL
RESOL_ANGULAR = cfg.RESOL_ANGULAR
CYL_HEIGHT = cfg.CYL_HEIGHT
CYL_RADIUS = cfg.CYL_RADIUS
CYL_N_CIRC = cfg.CYL_N_CIRC
CYL_N_LONG = cfg.CYL_N_LONG
CYL_ROT_AXIS = cfg.CYL_ROT_AXIS
CYL_ROT_ANGLE = cfg.CYL_ROT_ANGLE
NUM_LEVELS = cfg.NUM_LEVELS
TIKHONOV_FACTOR = cfg.TIKHONOV_FACTOR
CUT_WIDTH = cfg.CUT_WIDTH
POT_OFFSET_FACTOR = cfg.POT_OFFSET_FACTOR
MIN_LOOP_SIGNIF = cfg.MIN_LOOP_SIGNIF
NORMAL_SHIFT = cfg.NORMAL_SHIFT
NORMAL_SHIFT_SMOOTH = cfg.NORMAL_SHIFT_SMOOTH
...
# =============================================================================
# Derived constants — do not edit unless you know the mapping
# =============================================================================
