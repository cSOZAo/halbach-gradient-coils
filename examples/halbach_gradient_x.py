...
# --- 1. VARIABLES GLOBALES (Movidas aquí para que Windows las lea en todos los núcleos) ---
...
def process_combination(combination):
    ...
    param_dict['project_name'] = project_name_func(param_dict, combination)
...
if __name__ == '__main__':
    ...
    for combination in parameter_combinations:
        try:
            project_name_str = project_name_func(constant_params, combination)
