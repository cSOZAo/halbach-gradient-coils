"""
Port of GoldenAngle_GradientCoil.m to pyCoilGen — CHANNEL 3 [FROZEN].
...
This is the FROZEN per-channel reference for Channel 3. Do not modify.
"""
...
RUTA_SALIDA   = os.path.join(BASE_DIR, 'resultados_golden_angle_Ch3')
...
#     MATLAB lines 209-211 (Channel 3 offset = -2)
# =============================================================================
...
# =============================================================================
# 5.  COIL PARAMETERS — CHANNEL 3
#     MATLAB lines 209-243
# =============================================================================
cut_width                   = 0.04
min_loop_signifcance        = 2        # MATLAB Ch3
...
arg_dict = {
    # --- target field (Channel 3 uses GA3.mat / lin_1) ---
    'target_field_definition_file':       'OSI2_GradTarget_GA3.npy',
    ...
    'project_name':                 f'GoldenAngle_Ch3_tk{tikonov_factor}_lvl{num_levels}',
}

print("\n" + "=" * 70)
print("  Running pyCoilGen — GoldenAngle (Channel 3 / GA3) [FROZEN]")
print(f"  Cylinder: L=0.418 m, R={radius_ch3:.4f} m | Tikhonov={tikonov_factor}, levels={num_levels}")
print("=" * 70)
...
# =============================================================================
coil_name = 'A4IM_GoldenAngle_Ch3'
for plot_fn_name in [
