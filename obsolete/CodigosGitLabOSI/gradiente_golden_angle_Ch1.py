"""
Port of GoldenAngle_GradientCoil.m to pyCoilGen — CHANNEL 1 [FROZEN].
...
This is the FROZEN per-channel reference for Channel 1. Do not modify.
"""
...
RUTA_SALIDA   = os.path.join(BASE_DIR, 'resultados_golden_angle_Ch1')
...
#     MATLAB lines 131-133 (Channel 1 offset = -8)
# =============================================================================
...
# =============================================================================
# 5.  COIL PARAMETERS — CHANNEL 1
#     MATLAB lines 115-162
# =============================================================================
cut_width                   = 0.04
min_loop_signifcance        = 2        # MATLAB Ch1
...
# MATLAB radii(1) = 0.156
radius_ch1 = 0.156

# Cylinder mesh: height 0.418 m, 50×50 divisions, rotated [0 1 0] by π/2
cylinder_mesh_parameter_list = [
    0.418,        # height [m]
    radius_ch1,   # radius [m]
    50, 50,       # circumferential / longitudinal divisions
...
arg_dict = {
    # --- target field (Channel 1 uses GA1.mat / lin_1) ---
    'target_field_definition_file':       'OSI2_GradTarget_GA1.npy',
    ...
    'project_name':                 f'GoldenAngle_Ch1_tk{tikonov_factor}_lvl{num_levels}',
}

print("\n" + "=" * 70)
print("  Running pyCoilGen — GoldenAngle (Channel 1 / GA1) [FROZEN]")
print(f"  Cylinder: L=0.418 m, R={radius_ch1:.4f} m | Tikhonov={tikonov_factor}, levels={num_levels}")
print("=" * 70)
...
# =============================================================================
coil_name = 'A4IM_GoldenAngle_Ch1'
for plot_fn_name in [
